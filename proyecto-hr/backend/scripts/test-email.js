#!/usr/bin/env node
/**
 * Test de envío de email via Resend (sin dependencias externas).
  ...
  body: JSON.stringify({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px">
        ...
        <p style="color:#94a3b8;font-size:12px;margin-top:32px">Enviado desde test-email.js · ${new Date().toLocaleString("es-AR")}</p>
      </div>
    `,
  }),
});
